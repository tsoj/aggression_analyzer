...
# Feature weights
feature_weights = {
    "Advanced Pieces per Move": 0.464897,
    "Bishop/Queen Threats per Move": 1.693603,
    "Captures Near King": 0.204219,
    "Central Pawn Breaks per Move": 1.933665,
    "Checks per Move": 0.108865,
    "Coordinated Attacks per Move": 1.274895,
    "F7/F2 Attacks per Move": 0.979830,
    "Forcing Moves per Move": 0.000296,
    "Forfeited Castling Games": 1.877727,
    "Knight Outposts per Move": 1.999836,
    "Moves Near King": 0.888694,
    "Opposite-Side Castling Games": 1.693289,
