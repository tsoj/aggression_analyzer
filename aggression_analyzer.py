...
# Feature weights
feature_weights = {
    "Advanced Pieces per Move": 0.259221,
    "Bishop/Queen Threats per Move": 1.590935,
    "Captures Near King": 0.123812,
    "Central Pawn Breaks per Move": 1.733762,
    "Checks per Move": 0.069240,
    "Coordinated Attacks per Move": 0.691863,
    "F7/F2 Attacks per Move": 1.295168,
    "Forcing Moves per Move": 0.112132,
    "Forfeited Castling Games": 1.639429,
    "Knight Outposts per Move": 1.516500,
    "Moves Near King": 0.825953,
    "Opposite-Side Castling Games": 1.286039,
    "Pawn Storms per Move": 1.349720,
    "Rook Lifts per Move": 1.563244,
    "Rook/Queen Threats per Move": 1.172837,
    "Sacrifice Score per Win Move": 1.774037,
    "Short Game Bonus per Win": 1.874082,
}
